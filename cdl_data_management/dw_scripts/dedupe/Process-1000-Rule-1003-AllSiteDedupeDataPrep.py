    ...
    from 
      (
        select 
          ...
          country
        from 
          $$client_name_ctfo_datastore_staging_$$db_env.aact_facilities aact_facility where name is not null
      ) a 
    where 
      a.id is not null 
...
select 
    ...
    from 
      (
        ...
        from 
          $$client_name_ctfo_datastore_app_commons_$$db_env.tascan_site where site_name is not null
      ) a 
    where 
...
temp_ctms_site_data = spark.sql("""
    ...
    from $$client_name_ctfo_datastore_app_commons_$$db_env.usl_study_site_investigator usl_stdy_site_inv
...
spark.sql("""set hive.exec.dynamic.partition.mode=nonstrict""")
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data
PARTITION (
            pt_data_dt='$$data_dt',
...
temp_all_site_data
""")
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data")
...
spark.sql("""set hive.exec.dynamic.partition.mode=nonstrict""")
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_cleaned
PARTITION (
            pt_data_dt='$$data_dt',
            pt_cycle_id='$$cycle_id'
            )
...
""")
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_cleaned")
...
spark.sql("""set hive.exec.dynamic.partition.mode=nonstrict""")
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_aact
PARTITION (
            pt_data_dt='$$data_dt',
            pt_cycle_id='$$cycle_id'
            )
...
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_tascan
PARTITION (
            pt_data_dt='$$data_dt',
            pt_cycle_id='$$cycle_id'
            )
...
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep
PARTITION (
            pt_data_dt='$$data_dt',
            pt_cycle_id='$$cycle_id'
            )
...
spark.sql("""insert overwrite table $$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_3
PARTITION (
            pt_data_dt='$$data_dt',
            pt_cycle_id='$$cycle_id'
            )
...
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_aact")
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_tascan")
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep")
CommonUtils().copy_hdfs_to_s3("$$client_name_ctfo_datastore_app_commons_$$db_env.temp_all_site_data_prep_3")