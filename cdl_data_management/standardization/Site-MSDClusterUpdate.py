...
union 
select *  from site_records where lower(trim(type)) = 'd'""")
...
inner join xref_src_site_precedence_int1 b on trim(a.exp_golden_id) = trim(b.ctfo_site_id)
