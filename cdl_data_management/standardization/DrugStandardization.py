...
class DrugStandardization(object):
    ...
    def main(self):
       ...
       # config_data = drug_std.load_json(drug_std_config_file_location)
        ...
        print("=================================")
        #aact_drugs = '/usr/local/airflow/dags/plugins/code/aact_drugs.csv'
        aact_drugs = CommonConstants.AIRFLOW_CODE_PATH + '/aact_drugs.csv'

        #citeline_drugs = '/usr/local/airflow/dags/plugins/code/' \
        ...
        #os.system('mv /usr/local/airflow/dags/plugins/code/delta_drug/*.csv '
         #         '/usr/local/airflow/dags/plugins/code/aact_drugs.csv')
        #os.system('mv' + delta_drug_csv_path + ' ' + aact_drugs)
        os.system('mv ' + CommonConstants.AIRFLOW_CODE_PATH + '/delta_drug/*.csv '
                  + CommonConstants.AIRFLOW_CODE_PATH + '/aact_drugs.csv')
        ...
        #os.system('mv /usr/local/airflow/dags/plugins/code/citeline_drugs/*.csv '
         #         '/usr/local/airflow/dags/plugins/code/ispharmadrug_true_ctln.csv')
