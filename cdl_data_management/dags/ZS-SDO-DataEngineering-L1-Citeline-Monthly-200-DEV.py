...
FILE_MASTER_IDS = ["202", "203"]

PROCESS_ID = 200

DAG_NAME = "ZS-SDO-DataEngineering-L1-Citeline-Monthly-200-DEV"
...
copy_files = PythonOperator(
    task_id="copy_files", 
    python_callable=dagutils.call_citeline_sdo_files_copy, provide_context=True,
...
for file_master_id in FILE_MASTER_IDS:
    ...
    # Set task ordering
    pre_landing.set_upstream(copy_files)
