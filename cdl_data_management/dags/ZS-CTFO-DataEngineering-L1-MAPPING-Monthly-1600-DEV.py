...
FILE_MASTER_IDS = ["1601","1602"]

PROCESS_ID = 1600

DAG_NAME = "ZS-CTFO-DataEngineering-L1-MAPPING-Monthly-1600-DEV"
...
for file_master_id in FILE_MASTER_IDS:
    ...
    update_status = PythonOperator(
        ...
        op_kwargs={"file_master_id": file_master_id, "dag_name": DAG_NAME, "process_id": PROCESS_ID},
        dag=dag)
    mapping_utility = PythonOperator(
        task_id="mapping_utility_" + str(file_master_id),
        python_callable=dagutils.call_mapping_utility, provide_context=True,
        op_kwargs={"file_master_id": file_master_id, "dag_name": DAG_NAME, "process_id": PROCESS_ID},
        dag=dag)
    ...
    mapping_utility.set_upstream(update_status)
    emr_terminate.set_upstream(mapping_utility)
