...
class EMRClusterLauncher:
    ...
    def check_cluster_status(self,cluster_name):
        try:
            """
            Function : This functin is to get the cluster ID for the launched cluster via service catalog
            """
            emr_client = boto3.client('emr')

            # List clusters and filter by status 'WAITING' or 'CREATED'
    ...
    def provision(self,cluster_configs, service_catalog, bucket_name):
        try:
            ...
            #     {
            #         "scriptLocations": "s3://aws-a0339-use1-00-p-s3b-incy-spo-data01/clinical-data-lake/code/bootstrap/python37_emr_bootstrap.sh aws-a0339-use1-00-p-s3b-incy-spo-data01;/usr/local/airflow/dags/plugins/prod/ctfo;dev;integration;mwaa-dev;SP26212;yXMP3w6jE67pA2pHZFw7"},
