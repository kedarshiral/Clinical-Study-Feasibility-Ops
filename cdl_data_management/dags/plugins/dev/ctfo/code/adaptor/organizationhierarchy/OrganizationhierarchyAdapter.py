...
SCHEMA_FILE_NAME = "organizationhierarchy_schema.json"
SQL_FILE_NAME = "organizationhierarchy.sql"
...
class DataIngestionAdapter:
    ...
    def call_create_structured_file(
        ...
        try:
            ...
            ADAPTOR_LOCATION = CommonConstants.EMR_CODE_PATH + "/code/adaptor/organizationhierarchy"
    ...
    def main(self, input_dict):
        ...
        try:
            ...
            logging.info(status_message)
            self.data_source = "organizationhierarchy"
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    trigger_data_cmd = "cd " + str(EMR_CODE_PATH) + "/code/adaptor/organizationhierarchy/; python3 " \
                                       "OrganizationhierarchyAdapter.py ORGHIER " + " " + str(batch_id) + " " + str(payload_id) \
...
if __name__ == "__main__":
    try:
        ...
        data_source = "organizationhierarchy"
