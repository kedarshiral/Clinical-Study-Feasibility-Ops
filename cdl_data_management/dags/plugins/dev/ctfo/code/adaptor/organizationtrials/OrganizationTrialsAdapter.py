...
SCHEMA_FILE_NAME = "organizationtrials_schema.json"
SQL_FILE_NAME = "organizationtrials.sql"
...
class DataIngestionAdapter:
    ...
    def call_create_structured_file(
        ...
        try:
            ...
            ADAPTOR_LOCATION = CommonConstants.EMR_CODE_PATH + "/code/adaptor/organizationtrials"
    ...
    def main(self, input_dict):
        ...
        try:
            ...
            logging.info(status_message)
            self.data_source = "organizationtrials"
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    # Here we get the cluster id which was created in the OrganizationAdapter.py
                    # We select the cluster id from the table based on data_source and payload_id

                    query_str = (
                        "select cluster_id from {audit_db}.{log_data_acquisition_smry_table} "
                        " where source_name = 'organization' order by end_time desc limit 1"
                    )
                    output_query = query_str.format(audit_db=self.audit_db,
                                                    log_data_acquisition_smry_table=CommonConstants.LOG_DATA_ACQUISITION_SMRY_TABLE)
                    ...
                    logging.info("Query output cluster id - Bitbucket: %s", str(cluster_id_response))
                    self.cluster_id = cluster_id_response
                    ...
                    trigger_data_cmd = "cd " + str(EMR_CODE_PATH) + "/code/adaptor/organizationtrials/; python3 " \
                                       "OrganizationTrialsAdapter.py ORGTRI " + " " + str(batch_id) + " " + str(payload_id) \
...
if __name__ == "__main__":
    try:
        ...
        data_source = "organizationtrials"
