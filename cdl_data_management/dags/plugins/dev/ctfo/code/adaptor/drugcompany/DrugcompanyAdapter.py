...
class DataIngestionAdapter:
    ...
    def call_create_structured_file(
        ...
        try:
            ...
            ADAPTOR_LOCATION = CommonConstants.EMR_CODE_PATH + "/code/adaptor/drugcompany"
        ...
        try:
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    if cluster_id_fetched == '' and len(cluster_id_fetched)==0:
                    ...
                    trigger_data_cmd = "cd " + str(EMR_CODE_PATH) + "/code/adaptor/drugcompany/; python3 " \
                                       "DrugcompanyAdapter.py DRUGCOMPANY " + " " + str(batch_id) + " " + str(payload_id) \
