...
SCHEMA_FILE_NAME = "investigator_schema.json"
SQL_FILE_NAME = "investigator.sql"
...
class DataIngestionAdapter:
    ...
    def call_create_structured_file(
        ...
        try:
            ...
            ADAPTOR_LOCATION = CommonConstants.EMR_CODE_PATH + "/code/adaptor/investigator"
        ...
        try:
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    trigger_data_cmd = "cd " + str(EMR_CODE_PATH) + "/code/adaptor/investigator/; python3 " \
                                       "InvestigatorAdapter.py INV " + " " + str(batch_id) + " " + str(payload_id) \
