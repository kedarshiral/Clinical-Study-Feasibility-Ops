...
class RedShiftUtility(object):
    ...
    def _execute_copy_command(self, copy_command, redshift_connection, db_host, db_username, db_password, db_port,
        ...
        try:
            ...
            view_query_1 = "REFRESH MATERIALIZED VIEW ctfo_app_fa_dev.inv_completed_trials_vw"
            view_query_2 = "REFRESH MATERIALIZED VIEW ctfo_app_fa_dev.oncology_ta_vw"
            view_query_3 = "REFRESH MATERIALIZED VIEW ctfo_app_fa_dev.site_workload_vw"
