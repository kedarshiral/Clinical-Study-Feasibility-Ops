...
# python modify.py --path /appdata/dev/common_components/nntestbranch/sample/config.json --operation add --type include --input_type tags --values "{"ZS_Project_Code":"9901ZS6157","abc":"xyz"}"
