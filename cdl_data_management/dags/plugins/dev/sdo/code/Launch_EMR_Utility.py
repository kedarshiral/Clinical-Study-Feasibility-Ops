...
class Create_EMR(object):
    ...
    def __init__(self, event, bucket_name):
    ...
    def launch_emr_cluster(self):
        ...
        try:
            ...
            bitbucket_password = str(configuration.get_configuration(
                [CommonConstants.ENVIRONMENT_PARAMS_KEY, "bitbucket_password"]))
            print("bitbucket_password = " + str(bitbucket_password))
            ...
            if str(self.ami_version).startswith("emr-4") or str(self.ami_version). \
                ...
                if self.instance_fleet is not None:
                    ...
                    bitbucket_password = str(configuration.get_configuration([CommonConstants.ENVIRONMENT_PARAMS_KEY, "bitbucket_password"]))
                    if "cc_branch_name" in self.property_json:
                        default_cc_branch_name = self.property_json["cc_branch_name"]
                    else:
