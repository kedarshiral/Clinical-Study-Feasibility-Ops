...
class DataIngestionAdapter:
        ...
        try:
            ...
            if "aact_password" in application_config["adapter_details"]["aact"]:
                ...
                secret_password = self.get_secret(application_config["adapter_details"]
                                                  [self.data_source]["aact_password"],
                ...
                #     "token_pay_load"]
                aact_password = secret_password['aact_passwd']

                if not aact_password:
                ...
                logging.error("Mandatory key: aact_password not found in input")
                raise Exception("Mandatory key: aact_password not found in input")
            ...
            return {STATUS_KEY: SUCCESS_KEY, RESULT_KEY: self.s3_parquet_output_path}
    ...
    def call_launch_cluster(self, data_source_name):
        ...
        try:
            ...
            print("*****",emr_payload,region_name,data_source_name)
    ...
    def get_payload_json(self, payload_id):
        ...
        get_payload_query_str = "select payload_details_file_name,raw_file_dir," \
                                ...
                                "where payload_id" \
                                " = {payload_id}"
        print("paylod",get_payload_query_str)                        
