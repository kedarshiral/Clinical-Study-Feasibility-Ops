...
if __name__ == "__main__":
    ...
    with open(file_path) as file_object:
        ...
        execute_command_output = SshEmrUtility().execute_command(
            cluster_id=cluster_id_input, region_name=region_name_input, private_key_location=private_key_location_input,
            command=command_input)

        print(json.dumps(execute_command_output))
