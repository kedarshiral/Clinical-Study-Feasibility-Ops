...
################################# Module Information ######################################
#  Module Name         : All Site Precedence
#  Purpose             : This will execute queries to apply precedence rule on data coming
#                                                from xref_src_site and to prepare data for final_precedence_site
#                                                table
#  Pre-requisites      : Source table required: xref_src_site
#  Last changed on     : 22-03-2021
#  Last changed by     : Himanshi
#  Reason for change   : Adding the score precedence
#  Return Values       : NA
############################################################################################

################################### High level Process #####################################
# Prepare data for final_precedence_site table
############################################################################################
import json
...
rank_data_src asc,{source_id_column_name} desc, {score_column_name} desc""".\
