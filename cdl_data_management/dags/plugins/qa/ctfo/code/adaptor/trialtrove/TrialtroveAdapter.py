...
CLUSTER_CONFIG = "cluster_variables_trialtrove.json"
        ...
        try:
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    trigger_data_cmd = "cd " + str(EMR_CODE_PATH) + "/code/adaptor/trialtrove/; python3 " \
                                       "TrialtroveAdapter.py TRIAL " + " " + str(batch_id) + " " + str(payload_id) \
