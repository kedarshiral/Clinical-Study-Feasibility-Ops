...
ROLE_ARN = "RoleArn"
KEY_ECS = "ecs"
KEY_OPTIMIZATION_FILE_PATH = "optimization_file_path"
ECR_IMAGE = "ECR_IMAGE"
KEY_TAG_ZS_ENV = "ZS_Environment"
KEY_TAG_ZS_PROJ_CODE = "ZS_Project_Code"
KEY_TAG_ZS_CLIENT = "ZS_Client"
KEY_TAG_ZS_PRODUCT = "ZS_Product"
KEY_TAG_ZS_PROJ_NM = "ZS_Project_Name"
KEY_TAG_ZS_REQUESTOR = "ZS_Requestor"
# share service
...
SUCCESSFUL_RESPONSE_MANDATORY_KEYS = [ACCESS_TOKEN_KEY, TOKEN_TYPE_KEY, EXPIRES_IN_KEY, SCOPE_KEY,
                                      CLIENT_ID_KEY]
...
FINAL_RANK_LIST_FILE_NAME = "study_feasibility_list.xlsm"
PROJECT_ENROLLMENT_DETAILS_FILE_NAME = "project_enrollment.xlsx"
FINAL_RANK_OPTIMIZED_LIST_FILE_NAME = "study_feasibility_optimized_list.xlsm"
SITE_ZIP_FILE_NAME = "site_zip.zip"
FINAL_SITE_LIST_FILE_NAME = "study_feasibility_final_list.xlsm"
...
COUNTRY_VISUALIZATION_LOCAL_PATH = "/clinical_design_center/webservices/cdl_ctfo/{scenario_id}"
COUNTRY_VISUALIZATION_TEMPLATE_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/Country_Outreach_Visualisation.xlsm"

SITE_VISUALIZATION_LOCAL_PATH = "/clinical_design_center/webservices/cdl_ctfo/{scenario_id}"
SITE_VISUALIZATION_TEMPLATE_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/Site_Outreach_Visualisation.xlsm"
OUTREACH_TEMPLATE_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/Outreach_export.xlsm"
#OUTREACH_TEMPLATE_PATH = "/home/a1-d220cuscdl01/cdl_de_ctfo/clinical_design_center/webservices/cdl_ctfo/temp_files/Outreach_export.xlsm"
...
SURVEY_STATUS_500 = "Internal server error. Please contact ZS support at sanofi.clinicalsupport@zs.com"
SURVEY_STATUS_504 = "Request timed out. Please try again later"
SURVEY_STATUS_400 = "Please enter a valid email ID. If you are getting an error despite correct email ID, please contact ZS support"
GENERIC_SURVEY_STATUS = "System is unable to send out survey at the moment. Please try again later"
count_val = '3'
...
site_cols_non_ecda = ['QID2_1', 'QID2_4', 'QID2_5', 'QID2_6', 'QID2_7', 'QID2_8', 'QID2_9',
                      'QID2_10', 'QID2_11', 'QID2_12']

site_pi_speciality_cols = ['Q7_1', 'Q7_2']
site_pi_speciality_cols_non_ecda = ['QID7_1', 'QID7_2']

country_cols = ['QID58_10', 'QID58_11', 'QID58_12', 'QID58_13', 'QID58_14', 'QID58_15', 'QID58_16',
                'QID58_17', 'QID58_18']
...
gfl = "gfl"
mda = "mda"
super_user_role = "ctfo.admin"
admin_role = "ctfo.admin"
...
UPDATE_COUNTRY_METRIC_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/UpdateCountryMetricExportTemplate.xlsx"
UPDATE_SITE_METRIC_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/UpdateSiteMetricExportTemplate.xlsx"
# UPDATE_COUNTRY_METRIC_PATH = "/home/a1-d220cuscdl01/cdl_de_ctfo/clinical_design_center/webservices/cdl_ctfo/temp_files/UpdateCountryMetricExportTemplate.xlsx"
# UPDATE_SITE_METRIC_PATH = "/home/a1-d220cuscdl01/cdl_de_ctfo/clinical_design_center/webservices/cdl_ctfo/temp_files/UpdateSiteMetricExportTemplate.xlsx"
# #update tag:

UPDATE_SITE_TAG_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/UpdateTagsTemplate.xlsx"

# Outreach templates:
TEMP_SITE_QUALTRICS_EXPORT_FILE_NAME = "site_qualtrics_export_template.xlsm"
TEMP_COUNTRY_QUALTRICS_EXPORT_FILE_NAME = "country_qualtrics_export_template.xlsm"


OUTREACH_EXPORT_LOCAL_PATH = "/clinical_design_center/webservices/cdl_ctfo/{scenario_id}"
#OUTREACH_EXPORT_LOCAL_PATH = "/home/a1-d220cuscdl01/cdl_de_ctfo/clinical_design_center/webservices/cdl_ctfo/{scenario_id}"
...
# Visualization Path
UPDATE_SITE_VISUALIZATION_TEMPLATE_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/SiteVisualization.xlsx"
UPDATE_SITE_VISUALIZATION_LOCAL_PATH = "/clinical_design_center/webservices/cdl_ctfo/SiteVisualization.xlsx"
UPDATE_COUNTRY_VISUALIZATION_TEMPLATE_PATH = "/clinical_design_center/webservices/cdl_ctfo/temp_files/CountryVisualization.xlsx"
UPDATE_COUNTRY_VISUALIZATION_LOCAL_PATH = "/clinical_design_center/webservices/cdl_ctfo/CountryVisualization.xlsx"

# screen names
LAST_MODULE_ACTIVATED_SCREEN = ["country_rank", "country_rank_optimized", "country_rank_final",
                                "pi_rank", "pi_rank_optimized", "pi_rank_final",
                                "site_rank", "site_rank_optimized", "site_rank_final"]

# tables to update via UpdateRecord for Qualtrics
