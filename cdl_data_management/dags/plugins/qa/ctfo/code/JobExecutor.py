            ...
            if not rule_config_checks:
                ...
                for rule in rule_config_checks:
                    try:
                        ...
                        if "DedupeioProcess" in absolute_write_script_path:
                            command = "cd " + str(CommonConstants.EMR_CODE_PATH) + "/code; python3 " + str(rule_id) + "_" + script_name + ";"
                        elif absolute_write_script_path.endswith(".py") and "DedupeioProcess" not in absolute_write_script_path:
