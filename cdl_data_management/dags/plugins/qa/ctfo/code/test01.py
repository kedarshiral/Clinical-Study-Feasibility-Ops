...
bucket_name = 'aws-a0220-use1-00-d-s3b-shrd-shr-data01'
...
final_data_path = "s3://aws-a0220-use1-00-d-s3b-shrd-shr-data01/" +  prefix_value + "pt_cycle_id=" + str(max(cycle_id_list))
