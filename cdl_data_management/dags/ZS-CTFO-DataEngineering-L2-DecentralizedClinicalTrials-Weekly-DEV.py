...
# Name of the Dag
DAG_NAME = "ZS-CTFO-DataEngineering-L2-DecentralizedClinicalTrials-Weekly-DEV"
PROCESS_ID = 5000
FREQUENCY = "monthly"
...
Decentralized_Clinical_Trials = PythonOperator(
    task_id="Decentralized_Clinical_Trials",
    python_callable=dagutils.call_job_executor,
    op_kwargs={"process_id": PROCESS_ID,"frequency":FREQUENCY, "step_name": "Decentralized_Clinical_Trials"},
    dag=dag)
...
Decentralized_Clinical_Trials.set_upstream(launch_ddl_creation)
publish.set_upstream(Decentralized_Clinical_Trials)
