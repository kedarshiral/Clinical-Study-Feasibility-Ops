...
# Name of the Dag
DAG_NAME = "ZS-CTFO-DataEngineering-L2-IRRefactoring-Monthly-DEV"
PROCESS_ID = 7000
FREQUENCY = "monthly"
...
# #<---------------------->
IrUSL = PythonOperator(
    task_id="usl_study_site_investigator",
    python_callable=dagutils.call_job_executor,
    op_kwargs={"process_id": PROCESS_ID, "frequency": FREQUENCY, "step_name": "usl_ir"},
    dag=dag)
...
IrUSL.set_upstream(launch_ddl_creation)
publish.set_upstream(IrUSL)
