...
# Name of the Dag
DAG_NAME = "ZS-CTFO-DataEngineering-L2-CtmsRefactoring-Monthly-QA"
PROCESS_ID = 4000
FREQUENCY = "monthly"
...
publish.set_upstream(CtmsSite)

CtmsCountry.set_upstream(launch_ddl_creation)
publish.set_upstream(CtmsCountry)

CtmsStudy.set_upstream(launch_ddl_creation)
publish.set_upstream(CtmsStudy)
