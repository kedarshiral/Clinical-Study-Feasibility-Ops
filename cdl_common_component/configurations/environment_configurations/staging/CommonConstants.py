...
AIRFLOW_CODE_PATH = "/usr/local/airflow/dags/plugins/staging/ctfo/code"
DAGS_FOLDER = "/usr/local/airflow/dags"
DAG_PYTHON_FILE_PREFIX = "StagingProcess"
EMR_CODE_PATH = "/usr/local/airflow/dags/plugins/staging/ctfo"
...
AUDIT_DB_NAME = "stg_shrd_a0220_cus_01_ctfo"
