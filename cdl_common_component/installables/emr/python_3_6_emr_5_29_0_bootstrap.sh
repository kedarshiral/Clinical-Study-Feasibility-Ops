...
sudo aws s3 cp s3://$bucket_name/FTPIngestion/code/cc_enhancement_code_master.tar.gz $cluster_code_path
sudo gunzip $cluster_code_path/cc_enhancement_code_master.tar.gz
sudo tar -xf $cluster_code_path/cc_enhancement_code_master.tar -C $cluster_code_path
sudo chmod 777 -R $cluster_code_path


#install mysql-connector
sudo /usr/bin/pip-3.6 install setuptools
sudo /usr/bin/pip-3.6 install wheel
sudo /usr/bin/pip-3.6 install mysql-connector
sudo /usr/bin/pip-3.6 install awscli


#Install python logstash
sudo /usr/bin/pip-3.6 install python3-logstash
...
sudo /usr/bin/pip-3.6 install pyhive==0.5.2
sudo /usr/bin/pip-3.6 install thrift==0.11.0
sudo yum install cyrus-sasl-devel-2.1.23-13.16.amzn1 -y
sudo /usr/bin/pip-3.6 install sasl==0.2.1
sudo /usr/bin/pip-3.6 install thrift_sasl==0.3.0

#Install numpy and scipy
sudo /usr/bin/pip-3.6 install numpy
sudo /usr/bin/pip-3.6 install scipy
sudo /usr/bin/pip-3.6 install boto3

###Install packages for pysftp
sudo yum -y install gcc gcc-c++ kernel-devel
sudo yum -y install python-devel libxslt-devel libffi-devel openssl-devel
sudo /usr/bin/pip-3.6 install cryptography==2.9.2
sudo /usr/bin/pip-3.6 install pysftp


###Install requests module
sudo /usr/bin/pip-3.6 install requests

##Install PyMySQL
sudo /usr/bin/pip-3.6 install PyMySQL==1.0.2

#Install packages for Ganglia
sudo /usr/bin/pip-3.6 install pytz
sudo /usr/bin/pip-3.6 install selenium
sudo /usr/bin/pip-3.6 install fpdf
sudo /usr/bin/pip-3.6 install PyPDF2
sudo /usr/bin/pip-3.6 install pymysql
...
sudo /usr/bin/pip-3.6 install pyspark
