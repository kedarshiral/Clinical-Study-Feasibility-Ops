...
sudo aws s3 cp s3://$bucket_name/Demo_CC/code/code.tar.gz $cluster_code_path
...
sudo /usr/bin/pip-3.6 install setuptools==36.2.7
sudo /usr/bin/pip-3.6 install wheel==0.36.2
sudo /usr/bin/pip-3.6 install mysql-connector==2.2.9
sudo /usr/bin/pip-3.6 install awscli==1.18.198


#Install python logstash
sudo /usr/bin/pip-3.6 install python3-logstash==0.4.80
...
sudo /usr/bin/pip-3.6 install numpy==1.19.4
sudo /usr/bin/pip-3.6 install scipy==1.5.4
sudo /usr/bin/pip-3.6 install boto3==1.16.38

#Install packages for Ganglia
sudo /usr/bin/pip-3.6 install pytz==2019.3
sudo /usr/bin/pip-3.6 install selenium==3.141.0
sudo /usr/bin/pip-3.6 install fpdf==1.7.2
sudo /usr/bin/pip-3.6 install PyPDF2==1.26.0
...
sudo /usr/bin/pip-3.6 install pyspark==3.0.1
