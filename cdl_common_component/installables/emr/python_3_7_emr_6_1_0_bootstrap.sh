...
sudo yum -y install libxslt-devel libffi-devel openssl-devel
sudo /usr/bin/pip-3.7 install cryptography==2.9.2
sudo /usr/bin/pip-3.7 install pysftp

###Install requests module
sudo /usr/bin/pip-3.7 install requests

##Install PyMySQL
sudo /usr/bin/pip-3.7 install PyMySQL==1.0.2
