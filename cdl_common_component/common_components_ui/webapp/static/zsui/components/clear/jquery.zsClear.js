// Deprecated: Moved to components/form/
(function ($) {
	'use strict';
	var defaults = {
		render: {
	...
	zsClear.prototype.render = function () {
		...
		if (!this.$icon.length) {
			...
			//Match background color with that of input field. Assign default color as white.
			var bgColor=this.$input.css("background-color")!="rgba(0, 0, 0, 0)"?this.$input.css("background-color"):"white";
			...
			this.$icon.css({
				...
				background: bgColor, // TODO: not customizable
