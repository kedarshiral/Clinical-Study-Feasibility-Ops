...
file_path = f"s3://aws-a0339-use1-00-p-s3b-incy-spo-int-tscan-tdec01/in/{file_name_u}.csv"
...
df.coalesce(1).write.parquet(
    f's3://aws-a0220-use1-00-u-s3b-shrd-shr-demodata01/clinical-data-lake/temp/tascan_cleaned/{file_name_l}/',
    mode='overwrite'
)
...
source_bucket = 'aws-a0220-use1-00-u-s3b-shrd-shr-demodata01'
