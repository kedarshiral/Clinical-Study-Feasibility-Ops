...
class NotificationUtility(object):
    ...
    def send_notification(self, ses_region, subject, sender, recipient_list, email_body=None,
        ...
        try:
            ...
            FAILED_STATUS[NotificationUtilityConstants.ERROR_KEY] = str(ex,traceback.format_exc())
...
if __name__ == "__main__":
    ...
    #print(notification_utility.send_notification(input_ses_region,input_subject, input_sender, input_recipient_list,
    #                                             input_email_body, input_email_template,
    #                                             input_replace_param_dict))
    print(notification_utility.send_email_smtp(input_subject, input_sender, input_recipient_list,
                                                 input_email_body, input_email_template,
                                                 input_replace_param_dict))
