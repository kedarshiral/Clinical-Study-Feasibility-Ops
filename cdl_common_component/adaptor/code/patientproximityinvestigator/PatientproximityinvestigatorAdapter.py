...
class DataIngestionAdapter:
    ...
    def extract_data_from_pharma_intelligence(
        ...
        try:
            ...
            time.sleep(10)
            pre_landing_layer = "s3://aws-a0220-use1-00-u-s3b-shrd-shr-demodata01/clinical-data-lake/inbound/PATIENTPROXIMITY/PATIENTPROXIMITY_INVESTIGATOR"
    ...
    def call_create_structured_file(
        ...
        try:
            ...
            ADAPTOR_LOCATION = CommonConstants.EMR_CODE_PATH + "/code/adaptor/patientproximityinvestigator"
    ...
    def trigger_data_ingestion(
        ...
        try:
            ...
            output_status = self.extract_data_from_pharma_intelligence(
                ...
                disease_area_col_value, filter_payload, data_source
            )
        ...
        try:
            ...
            for payload_json in payload_json_list:
                ...
                for sub_payload in payload_json:
                    ...
                    pre_landing_path = sub_payload["raw_file_location"]
                    ...
                    logging.info("Query output: %s", str(response))
                    logging.info("sub_payload = %s", str(sub_payload))
                    logging.info("batch_id = %s", str(batch_id))
                    logging.info("FILE_ABS_PATH = %s", str(FILE_ABS_PATH))
                    logging.info("cluster_id = %s", str(cluster_id))
                    batch_id = ''
...
if __name__ == "__main__":
    try:
        ...
        data_source = "patientproximity_investigator"
        if str(source_name) == "PINV":
            batch_id = sys.argv[2]
            payload_id = sys.argv[3]
            FILE_ABS_PATH = sys.argv[4]
            cluster_id = sys.argv[5]
            f = open('payload_patientproximityinvestigator.json')
