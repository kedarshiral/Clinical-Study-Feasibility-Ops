...
class DataIngestionAdapter:
    ...
    def extract_data_from_pharma_intelligence(
        ...
        try:
            ...
            time.sleep(10)
            pre_landing_layer = "s3://aws-a0220-use1-00-u-s3b-shrd-shr-demodata01/clinical-data-lake/inbound/CITELINE/" \
                                "CITELINE_ORGANIZATION"
